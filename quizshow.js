var delay=10;
var correctAnswers=new Array("c","a","a","a","a");  //Answer
...
function show_question(){
	if (layer=eval("document.all.question"+q_num)){
		...
		document.all.quizScore.innerHTML="You got "+score+" out of 5 questions.";
...
function check_answer(answer){
	if (correctAnswers[q_num-1]==answer){
		score++;
		document.all.answerBoard.innerHTML="<font color=blue><b>Yes! You are correct!</b></font>";
	} else {
		document.all.answerBoard.innerHTML="<font color=red><b>No! You are wrong!</b></font>";
	}
	clock=0;
	clearTimeout(timer);
